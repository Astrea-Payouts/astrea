...
## Corpus Check
- 223 files · ~461,166 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1118 nodes · 1753 edges · 142 communities (67 shown, 75 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 15 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1c745ce1`
...
Cohesion: 0.11
Nodes (16): Astrea — Contracts Build Plan, Phase 0 — Spike (de-risk before anything else), Phase 1 — Production contract, Phase 2 — Hardening (before mainnet), Sequencing rules, CODE — Short task title, Money-path rules, Smart contracts (+8 more)
...
Cohesion: 0.07
Nodes (32): Update docs/ADRs alongside code policy, Fork-then-clone local setup workflow, Money-movement change review requirement (E0*, escrow calls, signing, reconciliation job), Opening a PR workflow, `security` label (extra review), upstream git remote, CI workflow, actions/checkout@v5 (+24 more)
...
### Community 22 - "session.ts"
Cohesion: 0.16
Nodes (21): dynamic, GET(), STELLAR_ACCOUNT_ID, STELLAR_NETWORK, AUTH_MESSAGE_PREFIX, consumeAuthNonce(), formatAuthMessage(), issueAuthNonce() (+13 more)
...
### Community 24 - "🌠 Astrea"
Cohesion: 0.12
Nodes (16): 🌠 Astrea, 📖 Documentation, Environment Variables, EscrowClient interface, 🏁 Getting Started, Go backend (services/core-go), 🚀 How It Works, 📄 License (+8 more)
...
### Community 111 - "docs/build-plan.md"
Cohesion: 0.20
...
### Community 120 - "stellar-network.ts"
Cohesion: 0.12
...
### Community 127 - "Astrea — UI motion & React Bits components"
Cohesion: 0.25
...
## Knowledge Gaps
- **413 isolated node(s):** `$schema`, `root`, `enabled`, `clientKind`, `useIgnoreFile` (+408 more)
