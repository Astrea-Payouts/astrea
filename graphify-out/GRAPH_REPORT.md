# Graph Report - astrea  (2026-08-30)

## Corpus Check
- 121 files · ~283,023 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 914 nodes · 1211 edges · 122 communities (51 shown, 71 thin omitted)
...
### Community 14 - "k02-go-soroban/main.go"
Cohesion: 0.08
Nodes (35): ConfirmTimeoutError, mockRPC, Pipeline, RPC, SimulateError, SubmitError, context.Context, github.com/stellar/go/clients/horizonclient.Client (+27 more)
...
Cohesion: 0.28
Nodes (15): testing.T, AddressArg(), TestAddressArgAccount(), TestAddressArgContract(), TestAddressArgRejectsInvalid(), emptyHostFn(), mustSorobanDataXDR(), readySim() (+7 more)
...
### Community 115 - "Go backend (services/core-go)"
Cohesion: 0.25
...
### Community 116 - "How It Works (5-step flow)"
Cohesion: 0.18
Nodes (11): Organizer funds the escrow step, Organizer creates an event step, How It Works (5-step flow), Judges approve and release step, Judge panel, Everything on the record step, Participants register and submit step, Multi-release smart escrow (+3 more)
...
### Community 118 - "Next.js (App Router)"
Cohesion: 0.33
