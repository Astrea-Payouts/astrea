...
## Corpus Check
- 95 files · ~266,678 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 792 nodes · 1023 edges · 116 communities (51 shown, 65 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 12 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6da20c86`
...
Cohesion: 0.05
Nodes (60): accounts, findOrCreateWallet(), Keys, main(), signXdr(), step(), ADR-0007, accounts (+52 more)
...
Cohesion: 0.10
Nodes (18): geistMono, geistSans, metadata, PrismBackground(), PrismBackgroundProps, LINKS, SiteFooter(), SiteHeader() (+10 more)
...
Cohesion: 0.16
Nodes (13): docs/build-plan.md, CI checks: lint, typecheck, test, build, CI enforcement of code-graph sync, GitHub Discussions, graphify-out/graph.html (interactive view), graphify-out/GRAPH_REPORT.md, graphify knowledge graph, /graphify --update command (+5 more)
...
Cohesion: 0.18
Nodes (13): docs/architecture.md, Astrea (escrow-backed prize payouts platform), docs/contracts-build-plan.md, Christopher Lamberti (Maintainer), MIT License, The Problem We Solve (broken hackathon-payout promises), docs/product-flows.md, shadcn/ui (+5 more)
...
### Community 23 - "docs/build-plan.md"
Cohesion: 0.25
Nodes (8): docs/build-plan.md, Organizer funds the escrow step, Multi-release smart escrow, Custom Soroban escrow smart contract (contracts/soroban), E01 task: migration from Trustless Work to custom Soroban contract, Stellar network, Task S01 (project scaffold), USDC

### Community 24 - "🌠 Astrea"
Cohesion: 0.17
Nodes (12): 🌠 Astrea, 📖 Documentation, Environment Variables, 🏁 Getting Started, 🚀 How It Works, 📄 License, 🧑‍🚀 Maintainers, Our Solution (+4 more)

### Community 25 - "Contributing to Astrea"
Cohesion: 0.17
...
### Community 26 - "Go backend (services/core-go)"
Cohesion: 0.25
...
### Community 103 - "Fail if graphify-out/ is stale step"
Cohesion: 0.22
...
### Community 104 - "tx-hash-link.tsx"
Cohesion: 0.29
Nodes (8): TxHashLink(), TxHashLinkProps, Button(), buttonVariants, getExplorerTxUrl(), StellarNetwork, truncateHash(), cn()

### Community 105 - "build-plan.md"
Cohesion: 0.25
Nodes (3): CODE — Short task title, K03 Ping Test Contract (CDIWLY6A...), K03 Wallet Compat Test Page

### Community 106 - "run.ts"
Cohesion: 0.29
...
### Community 108 - "K03 (server-build-plan.md) — wallet compatibility check"
Cohesion: 0.29
...
### Community 110 - "Astrea — UI motion & React Bits components"
Cohesion: 0.33
...
### Community 111 - "Astrea — Contracts Build Plan"
Cohesion: 0.40
...
### Community 112 - "PULL_REQUEST_TEMPLATE.md"
Cohesion: 0.40
Nodes (4): Docs, How I verified it, Money-path change?, What this does

### Community 113 - "K01 (server-build-plan.md) — custom Soroban escrow spike"
Cohesion: 0.40
...
### Community 114 - "K02 (server-build-plan.md) — Go ↔ Soroban integration spike"
Cohesion: 0.40
...
### Community 115 - "docs/architecture.md"
Cohesion: 0.67
