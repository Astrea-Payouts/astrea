...
## Corpus Check
- 226 files · ~466,661 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1147 nodes · 1780 edges · 140 communities (66 shown, 74 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 15 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `901d8c75`
...
### Community 132 - "layout.tsx"
Cohesion: 0.11
Nodes (23): geistMono, geistSans, viewport, PwaRegister(), ReduceMotionToggle(), ReduceMotionToggleProps, SiteFooter(), MotionPreferenceContext (+15 more)
...
Cohesion: 0.06
Nodes (37): OfflinePage(), LanguageSwitcher(), LOCALE_LABELS, resolveHeaderVariant(), PayoutFlowDemo(), StepConfig, STEPS, TransactionProgress() (+29 more)
...
## Knowledge Gaps
- **430 isolated node(s):** `$schema`, `root`, `enabled`, `clientKind`, `useIgnoreFile` (+425 more)
