...
## Corpus Check
- 93 files · ~267,970 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 787 nodes · 1004 edges · 115 communities (50 shown, 65 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 12 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6cf8a496`
...
## Communities (115 total, 65 thin omitted)
...
Cohesion: 0.05
Nodes (34): serverSchema, baseEnv, loadEnvWith(), ForwardPaymentParams, FROM, TO, ADR-0007, ROLES (+26 more)
...
### Community 23 - "Go backend (services/core-go)"
Cohesion: 0.29
...
### Community 25 - "Wallet testing"
Cohesion: 0.57
Nodes (7): Wallet testing, Albedo wallet, Freighter wallet, LOBSTR wallet, Stellar Wallets Kit, 👛 Wallet Requirements, xBull wallet

### Community 26 - "Fail if graphify-out/ is stale step"
Cohesion: 0.15
Nodes (13): graphify-out-rebuilt uploaded artifact, Fail if graphify-out/ is stale step, manifest.json/stat-index.json mtime exclusion from staleness diff, Chain is source of truth; database is a mirror, Environment Variables, 🏁 Getting Started, Stellar Horizon, Postgres (+5 more)
...
### Community 103 - "Contributing to Astrea"
Cohesion: 0.22
...
### Community 108 - "Opening a PR workflow"
Cohesion: 0.33
...
### Community 110 - "PULL_REQUEST_TEMPLATE.md"
Cohesion: 0.40
Nodes (4): Docs, How I verified it, Money-path change?, What this does

### Community 111 - "K01 (server-build-plan.md) — custom Soroban escrow spike"
Cohesion: 0.40
...
### Community 112 - "K02 (server-build-plan.md) — Go ↔ Soroban integration spike"
Cohesion: 0.40
