...
| K03 | ✅ **Done (2026-08-06)** — wallet compatibility check: confirm the contract works across the wallets the team plans to support (Freighter, Albedo, xBull, LOBSTR via Stellar Wallets Kit) | S | See [spikes/k03-wallet-compat](../spikes/k03-wallet-compat/README.md). Freighter ✅, Albedo ✅, xBull ✅ confirmed; LOBSTR partial/known limitation ⚠️ |
| K04 | ✅ **Done** — Fold K03's complete results into ADR-005 once all four wallets are tested | S | Fully folded into ADR-005 in [docs/architecture.md](architecture.md) |
