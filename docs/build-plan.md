...
| K04 | ✅ **Done (2026-09-07)** — Fold K03's complete wallet-compat results and library quirks into ADR-005 | S | Updated ADR-005 with 4-wallet compatibility matrix, static-class kit architecture, Albedo SEP-0043 limitation, and LOBSTR custom invocation status. See [docs/architecture.md](architecture.md#adr-005--wallet-connection-sets-a-ux-session-not-an-authorization-boundary) |
