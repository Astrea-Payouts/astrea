...
/**
 * Renders the public event's prize/milestone cards wrapped in React Bits' Border Glow.
 * On touch viewports (`pointerType === "touch"` or `(hover: none)`), Border Glow rests in
 * its static-border state without glow chase.
 */
						...
						return (
							<li key={prize.id} className="list-none">
								<BorderGlow
									...
									className="w-full rounded-2xl !bg-white !border-zinc-200 dark:!bg-[#09090b] dark:!border-white/15 transition-colors"
								>
